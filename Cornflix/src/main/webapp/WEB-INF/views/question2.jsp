...
<header><a href="" style="color: red; text-decoration: none; font-size: 30px;"><img src="/mvcProject/img/cornflix.png"></a></header>    
    <ul class="dropdownmenu">
        ...
        <div class="main">
        <nav ><h4 style="color: white;">Q [로그인] 에이콘티비 로그인 방법이 궁금해요.</h4></nav>
        <br>

        <h4 style="color: white;">A.CORNFILX는 아래와 같은 방법으로 로그인이 가능합니다.
            <br>
            
■ CORNFILX 로그인 방법<br>
1) 콘플릭스 WEB/APP 접속<br>
2) '콘플릭스 시작하기' 버튼 클릭<br>
3) 계정 선택화면에서 회원가입하신 계정 유형 선택<br>
4) 아이디, 비밀번호 입력 후 '로그인하기' 버튼 클릭<br>
<br>
<br>

혹시 일치하는 회원정보가 없다는 알림 메시지가 나오신다면 아래 사항을 확인하여 주세요.

<br>
<br>

* 'CORNFILX ID'로 로그인 시도하셨는데 일치하는 회원정보가 없다면 먼저 'CJ ONE으로 시작하기'를 선택하여 확인을 부탁드립니다.<br>
* 아이디가 이메일 형태의 계정인데 'ACORNTV ID'로 로그인이 안되시는 경우 SNS 연동 회원일 수 있으며, 네이버, 카카오 등 '각 SNS로 시작하기'를 선택하여 확인을 부탁드립니다. <br>
* 계정 유형을 맞게 선택하신 경우 '아이디 찾기', '비밀번호 찾기'를 진행해 주세요.<br>
<br>
<br>

지속해서 로그인이 되지 않으시는 경우 1:1 게시판 문의 또는 cornfilx@.net 으로 문의해 주시면,<br>
신속하게 가입하신 계정 확인하여 답변드리겠습니다.<br>
    </div>
