...
<header><a href="" style="color: red; text-decoration: none; font-size: 30px;"><img src="/mvcProject/img/cornflix.png"></a></header>    
    ...
    <div class="main">
        <nav ><h4 style="color: white;">Q [로그인] 로그인이 안될 때 고객문의를 남길 수 있는 방법이 있나요?</h4></nav>
        <br>

        <h4 style="color: white;">로그인이 되지 않으시는 경우 아래 콘플릭스 대표메일로 이메일 문의를 남겨주시면 확인 후 답변드리겠습니다.<br>
            - 콘플릭스 대표메일 : cornfilx@.net
            <br>
            <br>
            문의 내용에 발생 증상 외 기기 모델명, OS 버전, 브라우저, 네트워크 등 상세 정보를 남겨주시면 더욱 빠른 조치가 가능하오니 이용에 참고 부탁드립니다. <br>
    </div>
