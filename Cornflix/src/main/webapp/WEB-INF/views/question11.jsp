...
<header><a href="" style="color: red; text-decoration: none; font-size: 30px;"><img src="/mvcProject/img/cornflix.png"></a></header>    
    <ul class="dropdownmenu">
        ...
        <!--  hidden -->
            ...
            <div class="main">
        <nav ><h4 style="color: white;">Q [이벤트] 연간 이용권 특별 할인 기간과 금액이 궁금해요.</h4></nav>
        <br>

        <h4 style="color: white;">A.연간 이용권 할인 이벤트를 안내드립니다.
            <br>
            * 연간 이용권 할인 이벤트 안내
            <br>
            - 이벤트 기간 : 2023-12-01 ~ 2024-03-31<br>
            - 이벤트 가격<br>
            : 베이직 연간 (94,800원 → 66,000원)<br>
            스탠다드 연간 (130,800원 → 90,000원)<br>
            프리미엄 연간 (166,800원 → 114,000원)<br>
            <br>

            * 연간 이용권은 PC/모바일웹에서만 구매가 가능합니다.<br> 
            * 연간 이용권은 12월 1일 월간 이용권 신규 구독료 변경 이후에도 3월 31일까지 콘플릭스 페스타 할인가와 동일한 가격으로 구매하실 수 있습니다.<br>
            * 작년 동일 기간에 구매하신 연간 이용권 정기결제 유지 시, 할인 가격으로 결제됩니다.<br>
            * 할인 기간 동안 월정액 이용권을 연간 이용권으로 변경하셔도 할인 가격이 적용됩니다.<br>  
            * 할인 기간 동안 연간 이용권을 업/다운그레이드 하셔도 할인 가격이 적용됩니다.<br>
            (단, 다운그레이드 시 사용하신 기간은 12개월 정가 기준 일할 차감됩니다.)<br>
    </div>
