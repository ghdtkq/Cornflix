...
<header><a href="" style="color: red; text-decoration: none; font-size: 30px;"><img src="/mvcProject/img/cornflix.png"></a></header>    
    <ul class="dropdownmenu">
        ...
        <div class="main">
        <nav ><h4 style="color: white;">Q [변경] 정기결제수단 변경은 어떻게 하나요?</h4></nav>
        <br>

        <h4 style="color: white;">A.결제수단 변경은 PC와 모바일웹에서 변경하실 수 있습니다.<br>
            변경 방법은 아래 경로를 확인해 주세요.<br>
            <br>
            <br>
            ■ 결제수단 변경 방법<br>
            1) PC (WEB)<br>
