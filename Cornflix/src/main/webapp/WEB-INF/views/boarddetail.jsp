...
<header><a href="" style="color: red; text-decoration: none; font-size: 30px;"><img src="/mvcProject/img/cornflix.png"></a></header>    
    ...
    <div class="main">
        <nav ><h4 style="color: white;">문의 및 신고</h4></nav>
        <form method="post" name="myForm" action="/mvcProject/customerquestion" onsubmit="return ck()">
            <input type="text" placeholder="<%= data.getMember_category() %>" style="width: 40px; height: 30px; color: gray; text-align: center;" name="radio01" disabled>
            <br><br>
            <input type="text" placeholder="<%= data.getMember_id() %>" style="width: 1600px; height: 30px; color: gray;" name="text1" id="emailInput" disabled>
            <br><br><br>
            <input type="text" placeholder="<%= data.getMember_device1() %>" style="width: 1600px; height: 30px; color: gray;" name="select1" id="select1" disabled>
            <br>
            <input type="text" placeholder="<%= data.getMember_device2() %>" style="width: 1600px; height: 30px; color: gray;" name="select2" id="select2" disabled>
            <br>
            <input type="text" placeholder="<%= data.getMember_device3() %>" style="width: 1600px; height: 30px; color: gray;" name="select3" id="select3" disabled>
            <br><br>
            <textarea id="inputText" placeholder="<%= data.getMember_detail() %>" name="textarea1" style="width:1600px; height:100px;" disabled></textarea> 
    </form>
       </div>
    <div class="divbutton">
    <input type="button" onclick="document.location='/mvcProject/board'" class="button2" value="목록" style="width:1600px;">
