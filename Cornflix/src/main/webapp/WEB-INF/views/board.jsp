...
<head>
    ...
    <title>고객센터</title>
    <link rel="stylesheet" href="/mvcProject/css/board.css"  type="text/css">
</head>
<body>
<header><a href="" style="color: red; text-decoration: none; font-size: 30px;"><img src="/mvcProject/img/cornflix.png"></a></header>    
    <ul class="dropdownmenu">
    	...
    	<h2 style="color:white; margin-left: 400px; margin-top: 50px;">1:1 문의</h2>
	    <table class="board">
		    <tr>
			    <td style="width:200px;">분류</td>
			    <td style="width:300px;">이메일</td>
			    <td style="width:200px;">사용자기기</td>
			    <td style="width:150px;">웹/앱</td>
			    <td style="width:150px;">신고분야</td>
		    ...
		    %>
		    <tr>
			    <td style="background-color: rgb(25, 26, 26);"><%= board.getMember_category() %></td>
			    <td style="background-color: rgb(25, 26, 26);"><a style="color:white; text-decoration: none;" href="/mvcProject/boardresponse?postId=<%=board.getMember_num()%>"><%= board.getMember_id()%></a></td>
			    <td style="background-color: rgb(25, 26, 26);"><%= board.getMember_device1() %></td>
			    <td style="background-color: rgb(25, 26, 26);"><%= board.getMember_device2() %></td>
			    <td style="background-color: rgb(25, 26, 26);"><%= board.getMember_device3() %></td>
			 
		    </tr>
		    <%} %>
	    </table>    
	    <br><br>
	    <div class="pagination" style="text-align: center; text-decoration: none;">
        <span class="pagination-label">페이지:</span>
        <a href="/mvcProject/board?page=1" class="pagination-link">1</a>
        <a href="/mvcProject/board?page=2" class="pagination-link">2</a>
        <a href="/mvcProject/board?page=3" class="pagination-link">3</a>
        <a href="/mvcProject/board?page=4" class="pagination-link">4</a>
        <a href="/mvcProject/board?page=5" class="pagination-link">5</a>
        <a href="/mvcProject/board?page=6" class="pagination-link">6</a>
        <a href="/mvcProject/board?page=7" class="pagination-link">7</a>
        <a href="/mvcProject/board?page=8" class="pagination-link">8</a>
        <a href="/mvcProject/board?page=9" class="pagination-link">9</a>
        <a href="/mvcProject/board?page=10" class="pagination-link">10</a>
        <!-- 필요한 만큼 페이지 번호를 추가하십시오 -->
    </div>
