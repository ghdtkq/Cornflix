...
<header><a href="" style="color: red; text-decoration: none; font-size: 30px;"><img src="/mvcProject/img/cornflix.png"></a></header>    
   ...
   <div class="main">
        <nav ><h4 style="color: white;">Q [로그인] 이용권이 있는 계정이 무엇인지 찾고 싶어요.</h4></nav>
        <br>

        <h4 style="color: white;">A.유료 가입한 계정을 찾고 싶을 때, <br>
            ...
            ② [콘플릭스 시작하기] 클릭<br>
            ③ 가장 하단 [아이디 찾기] 클릭<br>
            ④ 본인인증으로 찾기 → [본인인증하기] 클릭<br>
            ⑤ 가입한 계정 ID들 안내<br>
            ⑥ 계정 ID 옆 (유료)로 표기된 계정으로 로그인<br>
            <br>
            <br>

            ※ 이메일로 찾기 시 확인되지 않으니, 반드시 본인인증으로 찾기로 이용 계정 확인해주세요.<br>
            ※ SNS 회원은 해당 SNS 아이디가 아닌 콘플릭스 가입 시 등록한 이메일을 알려드립니다.<br>
            ※ 본인인증이 완료된 계정만 확인이 가능합니다.<br>
            ※ 네이버플러스멤버십 이용권 계정은 본인인증찾기로 확인되지 않습니다.<br>

보다 자세한 확인이 필요한 경우, [1:1 게시판 문의] 또는 [cornfilx@.net]로 문의해 주시면 가입하신 계정 확인하여 답변드리겠습니다.
    </div>
